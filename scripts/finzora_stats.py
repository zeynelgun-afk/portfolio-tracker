#!/usr/bin/env python3
"""
DEPRECATED — Bu dosya 17 Mayıs 2026 itibarıyla agent/reports/stats.py'a taşındı.

Bu shim geriye dönük uyumluluk için tutuluyor; yeni kodda doğrudan
`agent.reports.stats` modülünü kullanın.
...
warnings.warn(
    "scripts/finzora_stats.py taşındı: agent/reports/stats.py kullanın "
...
_NEW_PATH = _REPO_ROOT / "agent" / "reports" / "stats.py"
