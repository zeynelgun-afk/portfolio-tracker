...
- **K-13b: ichimoku 4/4 istisnası (2 nisan 2026)**
  - gerekçe: 38 dönem backtestinde K-13b kriz modunda 9🎯 1⛔ 2— (%90 başarı). sistemin en güvenilir bileşeni. haber bazlı impulsif girişler ile sistematik ichimoku sinyalleri ayrıştırılmalı
...
- kanıt: 38 dönem backtestinde XLP hisselerinden (MO, PM, PEP, WMT, COST, KO) 0🎯 hedef, 2⛔ stop, 4 düz. hiçbir defansif hisse %10 swing hedefine ulaşamamış
