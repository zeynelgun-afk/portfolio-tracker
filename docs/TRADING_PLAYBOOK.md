...
- **K-13b: ichimoku 4/4 istisnası (2 nisan 2026)**
  - gerekçe: 51 dönem backtestinde K-13b kriz modunda 11 kâr / 2 zarar = %85 başarı. sistemin en güvenilir bileşeni. haber bazlı impulsif girişler ile sistematik ichimoku sinyalleri ayrıştırılmalı
...
- kural: XLP sektör ETF'ine dahil hisselerden swing trade sinyali değerlendirilmez. ABEF veya K-13b sinyal verse bile girme
...
- K-19: XLP (defansif) sektöründen swing girişi yapılmaz (yapısal düşük volatilite)
- SPY eğim: 21SMA eğimi ↗ yükseliyorken kâr oranı %67, ↘ düşerken %25
- backtest (51 dönem, 2021-2026): 63 trade → 42 kâr (%67) / 20 zarar (%32) | toplam P/L: +194.7% | ~+$20.2K
- başarı tanımı: kârda kapanan = başarılı (sadece %10 hedef değil)
- yıl bazlı: 2024 %100, 2025 %74, 2026 %85, 2023 %30, 2022 %40, 2021 %50
- regime notu: ABEF 2024-2026'da %85+, 2021-2023'te %30-50. K-13b her dönemde %85+
