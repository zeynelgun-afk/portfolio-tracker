...
- **K-13b: ichimoku 4/4 istisnası (yeni — 2 nisan 2026)**
  ...
  - istisna koşulları (TÜMÜ eşzamanlı sağlanmalı):
    ...
    2) sektör trendi aktif: hisse, o dönemin lider sektöründe olmalı (ör: savaş döneminde enerji). contrarian sektör oyunlarına istisna uygulanmaz
...
- hedef: ön filtreli girişlerde (A+B+E+F veya K-13b) sabit %10 hedef. filtresiz ichimoku girişlerde hedef yok, kijun trailing ile trend takip
