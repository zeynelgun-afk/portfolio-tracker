...
**v2.3 özeti**:
- ön filtre: ichimoku 4/4 zorunlu → VIX <22 → SPY > 21SMA + eğim ↗ → K-19 sektör kontrol. VIX >25 → K-13b
...
- ABEF kaldırıldı: 184 sinyal analizinde A/B/E/F filtreleri %0 iyileştirme sağladı. 4/4 ichimoku zorunluluğu +5p daha etkili
