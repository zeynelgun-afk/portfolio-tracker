...
**K-18: giriş öncesi insider trading kontrolü zorunlu**
- kanıt: POWL 25 mart'ta giriş yapıldı ($585.12). 23 mart'ta büyük hissedar Thomas Powell $25M'lık hisse satmıştı. 26 mart'ta POWL tek günde -%10.29 düştü. insider satışı giriş kararını etkileyecek önemli bir sinyal
- kural: yeni pozisyon açmadan önce FMP insider-trading endpoint'i kontrol et. son 30 günde büyük insider satışı varsa (>$5M veya CEO/CFO satışı) giriş yapma veya yarım pozisyonla gir
- ihlal maliyeti: POWL -%10.38 (1 gün)
