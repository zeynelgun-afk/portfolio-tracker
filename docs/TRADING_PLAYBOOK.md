...
- araştırma: akademik çalışmalar (Giot 2005, Bekaert & Hoerova 2014) yüksek VIX'in gelecek 30-60 gün getirileriyle pozitif korelasyonu olduğunu gösteriyor. Hartford Funds verisine göre VIX 40+ spike'larında yapılan yatırımlar takip eden yılda %25+ getiri sağlamış. Baker & Wurgler (2006): VIX yüksekken büyük, olgun, temettü ödeyen hisseler (duygu dalgasına dayanıklı) tutulmalı. jeopolitik krizlerde savunma, enerji, altın, sağlık sektörleri VIX'ten bağımsız yükseliyor. blanket VIX engeli fırsat maliyeti yarattı (mart 2026: agresif portföy %100 nakitte kalırken enerji +%10, savunma +%57 yıllık)
- kural (SEKTÖR BAZLI VIX MATRİSİ — v4, 6 nisan 2026):
  VIX-faydalanıcı sektörler: savunma (RTX, NOC, LMT, GD), enerji (XOM, CVX, DVN, COP), altın madencileri (NEM, GOLD, RGLD), sağlık (JNJ, MRK, PFE), temel tüketim/tütün (MO, PM, PG), telekomünikasyon (T, VZ), utilities
  VIX-duyarlı sektörler: tech/AI yarıiletken, tüketim döngüsel, küçük sermayeli büyüme, spekülatif/IPO
  VIX <22: tam pozisyon her iki grup
  VIX 22-28: tam pozisyon faydalanıcı | yarım pozisyon duyarlı
  VIX 28-35: yarım pozisyon faydalanıcı | giriş yok duyarlı
  VIX 35+: çeyrek pozisyon faydalanıcı | giriş yok duyarlı
  ⚠️ istisna: sistemik finansal kriz (2008 tarzı) durumunda tüm sektörler duyarlı sayılır
- pozisyon boyutu formülü: standart pozisyon × (22 / mevcut VIX). örnek: VIX 30'da standart $10K pozisyon → $10K × (22/30) = $7.3K
- stop genişlemesi: VIX 28+ iken stop mesafesi 2xATR → 3xATR'ye genişler, pozisyon başına max %3 portföy riski
- ihlal maliyeti: ALMU -%6.1, AROC -%4.95 (haber bazlı impulsif girişler — sektör bazlı kural bu hatayı zaten engellerdi)
...
**K-13: VIX sektör bazlı risk yönetimi (v4 — 6 nisan 2026)**
...
- kural: SEKTÖR BAZLI VIX MATRİSİ

  **VIX-faydalanıcı sektörler** (kriz döneminde güçlenen, VIX kaynaklı engel gevşer):
  ...
  - siber güvenlik (kriz döneminde talep artar): PANW, CRWD, FTNT

  **VIX-duyarlı sektörler** (kriz döneminde zayıflayan, VIX engeli tam uygulanır):
  ...
  **VIX bant matrisi:**
  ...
  ⚠️ **kritik istisna — sistemik finansal kriz**: VIX yükselişi jeopolitik değil sistemik finansal krizden (2008, banka iflası, kredi piyasası donması tarzı) kaynaklanıyorsa, TÜM sektörler duyarlı sayılır. sektör ayrımı yalnızca jeopolitik/bölgesel kriz kaynaklı VIX yükselişlerinde geçerlidir
  ...
  **ek kurallar (VIX 28+ iken tüm sektörlerde geçerli):**
  ...
  - pozisyon boyutu formülü: standart pozisyon × (22 / mevcut VIX). örnek: VIX 30'da $10K → $10K × (22/30) = $7.3K
...
- **K-13b: ichimoku 4/4 istisnası (artık her iki sektör grubunda da geçerli)**
  - gerekçe: 51 dönem backtestinde K-13b kriz modunda 11 kâr / 2 zarar = %85 başarı. K-13 v4 ile birlikte ichimoku 4/4 istisnası zaten faydalanıcı sektörlere tam uygulanabilir. duyarlı sektörlerde ise VIX 28-35 bandında ichimoku 4/4 + tüm koşullar sağlanırsa çeyrek pozisyon izni verir
...
- kapsam: sadece VIX <22 normal mod. K-13b kriz modunda uygulanmaz (krizin kendi sektör ETF SMA filtresi var)
...
**v2.3 özeti**:
- ön filtre: ichimoku 4/4 zorunlu → VIX <22 → SPY > 21SMA + eğim ↗ → K-19 → K-20. VIX >25 → K-13b
...
- hedef: sabit %10. portföy pozisyonlarında K-11 kademeli çıkış uygulanır
